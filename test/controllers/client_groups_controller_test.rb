...
class ClientGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create client_group" do
    assert_difference('ClientGroup.count') do
      post client_groups_url, params: { client_group: { Name: @client_group.Name, SigfoxGroupID: @client_group.SigfoxGroupID, SigfoxGroupName: @client_group.SigfoxGroupName } }
    end
  ...
  test "should update client_group" do
    patch client_group_url(@client_group), params: { client_group: { Name: @client_group.Name, SigfoxGroupID: @client_group.SigfoxGroupID, SigfoxGroupName: @client_group.SigfoxGroupName } }
